...
describe Api::V1::ItemsController do
  let!(:items) { create_list :merchant, 20 }
  ...
  describe 'GET /v1/items' do
    describe 'with no params' do
      ...
      it 'returns proper data keys' do
        ...
        expect(attrs).to have_key(:unit_price)
        expect(attrs).to have_key(:merchant_id)
      end
    end
  ...
  describe 'GET /v1/merchants/:id' do
    ...
    describe 'given a merchant' do
      ...
      it 'will raise an error if invalid id is input' do
        expect { get api_v1_merchant_path(100_000) }.to raise_error(ActiveRecord::RecordNotFound)
      end
    end
